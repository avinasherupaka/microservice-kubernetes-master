...
```
[~/microservice-kubernetes/microservice-kubernetes-demo]export DOCKER_ACCOUNT=avinasherupaka
...
The push refers to a repository [docker.io/avinasherupaka/microservice-kubernetes-demo-hystrix-dashboard]
f4ffcb9c643d: Pushed 
14c5bfa09694: Mounted from avinasherupaka/microservice-kubernetes-demo-order 
41a5c76632fc: Mounted from avinasherupaka/microservice-kubernetes-demo-order 
5bef08742407: Mounted from avinasherupaka/microservice-kubernetes-demo-order 
...
from the Docker Hub account `avinasherupaka`. You will need to modify the YAML
